    ...
    return {
        ...
        callback: function(e) {
            ...
            for (a = 0; a < d;) {
                ...
                A && (b += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + h[a] + '" class="twitter_reply_icon"><i class="fa fa-reply"></i> Reply</a><a href="https://twitter.com/intent/retweet?tweet_id=' + h[a] + '" class="twitter_retweet_icon"><i class="fa fa-retweet"></i> Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id=' +
                h[a] + '" class="twitter_fav_icon"><i class="fa fa-star"></i> Favorite</a></p>');
                c.push(b);
                a++
            }
            if (null == w) {
                ...
                for (h = "<ul" + ' id="tweets">'; g < e;)
                    h += "<li" + ' class="col-md-4">' + c[g] + "</li>", g++;
                f.innerHTML = h + "</ul>"
            } else 
                w(c);
            t=!1;
...
// hashtags.
twitterFetcher.fetch('592665223351369729', 'tweet-container', 3, true);
